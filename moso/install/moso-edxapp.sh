...
COMMON_PYPI_MIRROR_URL="https://mirrors.aliyun.com/pypi/simple"
...
##
cd /var/tmp/configuration/playbooks && sudo -E ansible-playbook -c local ./moso_edxapp.yml -i "localhost," $EXTRA_VARS "$@"
ansible_status=$?
